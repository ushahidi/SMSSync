        ...
        <div class="bs-sidebar hidden-print" role="complementary">
            <ul class="nav bs-sidenav">
                <li>
                    ...
                    <ul class="nav">
                        <li>
                            <a href="#add-new-syncurl">Add new Sync URL</a>
                        </li>
                        <li>
...
2. Tap on the ![Add icon]({{urls.media}}/icons/new.png) icon on the actionbar. An input dialog should open.
...
2. Tap on the ![Edit icon]({{urls.media}}/icons/edit.png) icon on the actionbar. An input dialog should open repopulated with the details of the Sync URL.
...
3. Tap on the ![Delete icon]({{urls.media}}/icons/delete.png) icon on the actionbar. A confirmation dialog should open.
...
1. Go to Settings screen by tapping the ![Settings icon]({{urls.media}}/icons/settings.png) icon on the actionbar or option menu.
...
1. Tap on the ![Sync icon]({{urls.media}}/icons/refresh.png) icon on the actionbar. The sync icon should spin for a while.
...
2. Tap on the ![Sync icon]({{urls.media}}/icons/refresh.png) icon on the actionbar. The sync icon should spin for a while.
...
1. Tap on the ![Delete icon]({{urls.media}}/icons/delete.png) icon on the actionbar. A confirmation dialog should open.
...
1. Tap on the ![Import icon]({{urls.media}}/icons/import.png) icon on the actionbar. A progress dialog should open. Leave it to run until it finishes. Depending on the number of messages in your inbox, this could take a while.
...
2. Tap on the ![Delete icon]({{urls.media}}/icons/delete.png) icon on the actionbar. A confirmation dialog should open.
