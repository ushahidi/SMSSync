...
public class SentMessagesActivity extends Activity {
	...
	public static final String CLASS_TAG = SentMessagesActivity.class
			.getSimpleName();
	...
	public boolean onContextItemSelected(MenuItem item) {
		...
		Log.i(CLASS_TAG, "delete sent messages by id via context menu "
				+ messageId);
	...
	final Runnable mDeleteAllSentMessages = new Runnable() {
		public void run() {
			...
			try {
				if (deleted == 1) {
					Util.showToast(SentMessagesActivity.this,
