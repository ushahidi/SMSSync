...
public class MessagesTabActivity2 extends ActivityGroup {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setupTab(new TextView(this), getString(R.string.pending_messages), new Intent(
                MessagesTabActivity2.this, PendingMessagesActivity.class));
        setupTab(new TextView(this), getString(R.string.sent_messages), new Intent(
                MessagesTabActivity2.this, SentMessagesActivity.class));
    }
