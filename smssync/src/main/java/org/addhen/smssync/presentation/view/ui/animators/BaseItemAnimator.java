...
import org.addhen.smssync.presentation.view.ui.adapter.AnimateItemViewHolder;
...
public abstract class BaseItemAnimator extends SimpleItemAnimator {
    ...
    private void preAnimateRemove(final RecyclerView.ViewHolder holder) {
        ...
        if (holder instanceof AnimateItemViewHolder) {
            ((AnimateItemViewHolder) holder).preAnimateRemoveImpl();
        } else {
    ...
    private void preAnimateAdd(final RecyclerView.ViewHolder holder) {
        ...
        if (holder instanceof AnimateItemViewHolder) {
            ((AnimateItemViewHolder) holder).preAnimateAddImpl();
        } else {
    ...
    private void doAnimateAdd(final RecyclerView.ViewHolder holder) {
        if (holder instanceof AnimateItemViewHolder) {
            ((AnimateItemViewHolder) holder).animateAddImpl(new DefaultAddVpaListener(holder));
        } else {
