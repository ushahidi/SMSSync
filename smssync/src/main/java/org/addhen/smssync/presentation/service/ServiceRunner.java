...
/**
 * Runs all the automated services
 *
 * @author Ushahidi Team <team@ushahidi.com>
 */
public class ServiceRunner {

    public static final String CLASS_TAG = ServiceRunner.class.getSimpleName();
    ...
    public ServiceRunner(Context context, PrefsFactory prefsFactory, FileManager fileManager) {
        mContext = context;
