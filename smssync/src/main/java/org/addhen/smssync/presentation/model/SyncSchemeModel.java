...
public class SyncSchemeModel {
    ...
    public SyncSchemeModel(String json) {
        try {
    ...
    public SyncSchemeModel(SyncMethod method, SyncDataFormat dataFormat) {
        init(
                method,
                dataFormat,
                "secret", "from",
