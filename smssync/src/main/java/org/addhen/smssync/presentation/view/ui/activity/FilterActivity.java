 ...
 */
public class FilterActivity extends BaseActivity implements HasComponent<FilterComponent> {

    private static final String FRAG_TAG = "list_filters";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        injector();
        mFilterFragment = (FilterFragment) getSupportFragmentManager()
                .findFragmentByTag(FRAG_TAG);
        if (mFilterFragment == null) {
            mFilterFragment = FilterFragment.newInstance();
            replaceFragment(R.id.add_fragment_container, mFilterFragment);
        }
    }
