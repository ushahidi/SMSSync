 ...
 */
public class AddFilterUsecaseTest {

    private AddFilterUsecase mAddFilterUsecase;
    ...
    public void setUp() throws Exception {
        ...
        mAddFilterUsecase = new AddFilterUsecase(mMockFilterRepository, mMockThreadExecutor,
                mMockPostExecutionThread);
    }

    @Test
    public void shouldSuccessfullyAddAFilter() {
        final FilterEntity filterEntity = DomainEntityFixture.getFilterEntity();
        mAddFilterUsecase.setFilter(filterEntity);
        mAddFilterUsecase.buildUseCaseObservable();
        verify(mMockFilterRepository).addEntity(filterEntity);
